...
export const caseStudy = {
  ...
  title: 'NokAcademy',
  description:
    'In partnership with AAASME and AU, This initiative aims to identify, develop, and tokenize African-based businesses and is primed for a full-fledged launch.',
  summary: [
    'In partnership with AAASME and AU, This initiative aims to identify, develop, and tokenize African-based businesses.',
