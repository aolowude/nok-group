...
export const caseStudy = {
  ...
  title: 'NokPay',
  description:
    'Our retail and B2B banking platform empowered by proprietary technology with multi-jurisdictional account opening, digital asset wallet creation and more.',
  summary: [
