import logo from '@/images/logos/mark/nokTech.svg'
...
export const caseStudy = {
  ...
  title: 'NokTech',
  description:
    'The basis for the future of African crypto, the $NOK token, with a bespoke wallet and rewards programme. ',
  summary: [
    'The basis for the future of African crypto, the $NOK token, with a bespoke wallet and rewards programme.',
    'An NFT platform using proven technology allowing entrepreneurs and artists to realise their true potential. The African development consultancy and agency for the NokGroup, building end-to-end platforms and blockchain solutions for African consumers.',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
  service: 'Token and Digital Assets',
  testimonial: {
