import logo from '@/images/logos/mark/nokAcademy.svg'
...
export const caseStudy = {
  ...
  title: 'NokAcademy',
  description:
    'In partnership with a number of Pan African Associations, this initiative aims to identify, develop, and tokenize African-based businesses and is primed for a full-fledged launch.',
  summary: [
    'In partnership with a number of Pan African Associations, this initiative aims to identify, develop, and tokenize African-based businesses.',
    'NokAcademy stands as an owned and operated portfolio business unit committed to fostering business growth and innovation and is primed for a full-fledged launch.',
  ],
  logo,
  image: { src: imageHero },
  date: '2022-10',
  service: 'Business & Blockchain Education',
  testimonial: {
