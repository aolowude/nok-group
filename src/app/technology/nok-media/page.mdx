import logo from '@/images/logos/mark/nokMedia.svg'
...
export const caseStudy = {
  ...
  title: 'NokMedia',
  description:
    'We hold exclusive rights to establish and operate co-branded digital, radio, and TV media publications in collaboration with global media owners to distribute content across Africa.',
  summary: [
    'We hold exclusive rights to establish and operate co-branded digital, radio, and TV media publications in collaboration with global media owners to distribute content across Africa, leveraging full marketing expertise to effectively launch, expand, and strengthen our product portfolio.',
  ],
  logo,
  image: { src: imageHero },
  date: '2022-06',
  service: 'Content Creation & Distribution',
  testimonial: {
