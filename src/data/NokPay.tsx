...
import { Icon_NokPay_logo } from '../components/Icons'
...
function NokPay() {
  const data: ContentWithImageType = {
    ...
    content: (
      <>
        <p>
          A best-in-class financial technology digital platform and intuitive
          user interface covering regulated fiat, crypto and card transaction
          services. Using exciting marketing and branding to create a strong
