...
import { Icon_NokMedia_logo } from "../Icons"
...
function NokMedia() {
  const data: ContentWithImageType = {
    ...
    content: (
      <>
        <p>
          Creating a strong voice advocating for African economic opportunities, promoting our community of investors and changing investor
          perceptions. Building a pan-African identity and entrepreneur ecosystem and leveraging creators and influencers to promote the
          NokGroup brand.
        </p>
      </>
    ),
