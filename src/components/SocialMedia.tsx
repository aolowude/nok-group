...
export const socialMediaProfiles = [
  {
    title: 'Facebook',
    href: 'https://www.facebook.com/nokpay.africa/',
    icon: FacebookIcon,
  },
  {
    title: 'Instagram',
    href: 'https://www.instagram.com/nokpay_',
    icon: InstagramIcon,
  },
  { title: 'Twitter', href: 'https://twitter.com/NokPay_', icon: TwitterIcon },
  {
    title: 'LinkedIn',
    href: 'https://linkedin.com/company/nokpay',
    icon: LinkedInIcon,
  },
]
